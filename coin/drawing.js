...
function draw() {
  ...
  if (gameStart) {
    ...
    textSize(20)
    text("To move, press either the arrow keys or WASD keys.", width / 2, (height / 2) - 80)
    text("To create platforms, click the mouse on where you would like to build a platform.", width / 2, (height / 2) - 40)
    text("If you would like to start the game, click the button below.", width / 2, height / 2)
...
function animationSetup() {
  ...
  myAnimation = player.addAnimation("idle", "player1-1.png", "player1-1.png")
  player.addAnimation("moving", "player1-1.png", "player1-2.png")
  player.addAnimation("jumping", "player1-3.png", "player1-3.png")
}
